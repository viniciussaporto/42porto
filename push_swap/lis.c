...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/05 18:04:29 by vsa-port          #+#    #+#             */
/*   Updated: 2023/05/05 18:40:28 by vsa-port         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

void	ft_push_not_list(t_stack **s1, t_stack **s2, int *lis, int lis_size)
{
	int	s1_size;
	t_stack *temp;
...
int	*ft_lis_n(t_list *s, int *lis_pos, int size)
{
	int	i;
...
void	ft_lis(t_stack **s1, t_stack **s2)
{
	...
	ft_push_not_list(s1, s2, lis_pos, lis_len[max_i]);
	free(lis_pos);
	free(lis_len);
}